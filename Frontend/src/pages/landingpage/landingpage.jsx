...
const Landingpage = () => {
  ...
  const renderAssessmentContent = () => {
    ...
    // Case 3: Show results after completion
    return (
      <AssessmentResults
        assessmentType={currentAssessment}
      ...
      >
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          <p className="text-sm" style={{ color: "#4A4A4A" }}>
            This website is for supportive purposes only and is not a substitute
            for professional mental health care. If you are experiencing a
            mental health emergency, please contact 112 or your local emergency
            services.
          </p>
        </div>
      </footer>
